...
ENDPOINT_ALIASES: Dict[str, List[str]] = {
    ...
    "/languages": ["/v1/languages", "/v1/audio/languages", "/supported-languages"],
    "/voices": ["/v1/voices", "/v1/audio/voices", "/voice-library", "/voice_library"],
    "/voices/default": ["/v1/voices/default", "/v1/audio/voices/default", "/default-voice"],
    "/voices/{voice_name}": ["/v1/voices/{voice_name}", "/v1/audio/voices/{voice_name}"],
    "/voices/{voice_name}/download": ["/v1/voices/{voice_name}/download", "/v1/audio/voices/{voice_name}/download"],
    "/voices/{voice_name}/aliases": ["/v1/voices/{voice_name}/aliases", "/v1/audio/voices/{voice_name}/aliases"],
    "/voices/{voice_name}/aliases/{alias}": ["/v1/voices/{voice_name}/aliases/{alias}", "/v1/audio/voices/{voice_name}/aliases/{alias}"],
    "/voices/all-names": ["/v1/voices/all-names", "/v1/audio/voices/all-names"],
    "/voices/cleanup": ["/v1/voices/cleanup", "/v1/audio/voices/cleanup"],
    "/health": ["/v1/health", "/status"],
    "/models": ["/v1/models","/v1/audio/models"],
    "/config": ["/v1/config"],
